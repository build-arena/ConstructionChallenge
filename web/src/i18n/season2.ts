...
const enPatch = {
  ...
  leaderboard: { tag: "// 07 — Leaderboard", title: "Season 02 Leaderboard", status: "Not open yet", emptyTitle: "The loop is warming up", emptyBody: "The competition opens Sep 20, 2026 AOE. Submit a verified final mission to appear after unified scoring." },
  faq: {
    tag: "// 08 — Rules FAQ",
    title: "Season 02 FAQ",
...
const zhPatch = {
  ...
  leaderboard: { tag: "// 07 — 排行榜", title: "第二赛季排行榜", status: "尚未开放", emptyTitle: "闭环正在预热", emptyBody: "比赛将于 2026-09-20 AOE 开始；统一评分后，提交 verified 最终任务即可展示。" },
